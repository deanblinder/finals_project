...
async function addNewAnswer(user_id,agent_type,ans_1,ans_2,ans_3,ans_4,ans_5,ans_6,ans_7,game_num) {
    console.log(" in addNewAnswer")
    // console.log(qDict)
    // console.log("length: ", Object.keys(qDict).length)
    await DButils.execQuery(
        `INSERT INTO userAnswers (user_id,agent_type,ans_1,ans_2,ans_3,ans_4,ans_5,ans_6,ans_7,game_num)VALUES ('${user_id}','${agent_type}','${ans_1}','${ans_2}','${ans_3}','${ans_4}','${ans_5}','${ans_6}','${ans_7}','${game_num}')`
    );
}
