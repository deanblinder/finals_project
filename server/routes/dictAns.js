...
router.post("/addAnswers/:mail/:agentType/:ans1/:ans2/:ans3/:ans4/:ans5/:ans6/:ans7/:gameNum", async (req, res, next) => {
    try {
        //id = uuid
        ...
        const game_num = req.params.gameNum
        await userAnswers_utils.addNewAnswer(mail,agentType,ans_1,ans_2,ans_3,ans_4,ans_5,ans_6,ans_7,game_num);
