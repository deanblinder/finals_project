...
router.post("/addAnswers/:deviceUUID/:agentType/:ans1/:ans2/:ans3/:ans4/:ans5/:ans6/:ans7", async (req, res, next) => {
    try {
        //id = uuid
        ...
        await userAnswers_utils.addNewAnswer(deviceUUID,agentType,ans_1,ans_2,ans_3,ans_4,ans_5,ans_6,ans_7);
